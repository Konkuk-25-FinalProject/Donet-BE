...
public class EditUserProfileController implements UserController{
    ...
    @PatchMapping(value = "/users/me/profile-image")
    public BaseResponse<Void> editUserProfileImage(@CurrentUserId Long userId,
    ...
    public BaseResponse<Void> editUserNickname(@CurrentUserId Long userId,
                                               @Validated @NotBlank String nickname
    ){
    ...
    public BaseResponse<Void> editUserWalletAddress(@CurrentUserId Long userId,
                                                    @Validated @NotBlank String walletAddress
    ){
