...
public enum BaseExceptionResponseStatus implements ResponseStatus{
    ...
    NOT_FOUND_RECOMMEND_DONATION(HttpStatus.NOT_FOUND.value(), 3006, "추천 기부를 찾을 수 없습니다."),
    NOT_FOUND_POPULAR_DONATION(HttpStatus.NOT_FOUND.value(), 3007, "인기 기부를 찾을 수 없습니다."),
